...
| `affinity`                                 | Affinity                                                                                                                               | `{}`                                                |
| `gangSchedulingManagement`                 | Configuration for gang scheduling. When set the scheduler name, gang scheduling will be enabled. For example: `schedulerName: volcano` | `{}`                                                |