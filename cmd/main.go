...
func setupControllers(mgr ctrl.Manager, certsReady chan struct{}, cfg configapi.Configuration) {
	...
	// Set up replica resource provider
	...
	if cfg.GangSchedulingManagement != nil {
		...
		setupLog.Info("Enabled gang scheduling", "provider", *cfg.GangSchedulingManagement.SchedulerProvider)
	}
	...
	if os.Getenv("ENABLE_WEBHOOKS") != "false" {
		...
		if err := pw.SetupPodWebhook(mgr); err != nil {
